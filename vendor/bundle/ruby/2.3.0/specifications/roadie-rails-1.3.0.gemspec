# -*- encoding: utf-8 -*-
# stub: roadie-rails 1.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<railties>.freeze, ["< 5.3", ">= 3.0"])
      s.add_development_dependency(%q<rails>.freeze, ["< 5.3", ">= 4.2"])
      ...
      s.add_dependency(%q<railties>.freeze, ["< 5.3", ">= 3.0"])
      s.add_dependency(%q<rails>.freeze, ["< 5.3", ">= 4.2"])
